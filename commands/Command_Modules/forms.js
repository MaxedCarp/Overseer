...
class forms {
    static GetForm(number, gname, gicon, ){
		return new Promise((resolve) => {
			(async () => {
				const helpChannels = await EmbedCreator.Create(`Command List - Page 1: Channels`, `< > - Parameter\n(< > < >...) - Optional parameter(s)\nExample for commands that require time:\n/tempban user:maxedcarp time:5 hours 3m 31 second`, false, gname, gicon, `Help Form`, `https://maxedcarp.net/imgs/overseer.png`, 0x00A012, [{ name: 'Channels', value: "----------------" }, { name: '/setlogchannel <type>', value: "Sets the specified logs channel to the channel the command is executed in." }, { name: '/unsetlogchannel <type>', value: "Unsets the specified logs channel." }]);
