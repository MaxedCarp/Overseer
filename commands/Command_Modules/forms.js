        ...
        return new Promise((resolve) => {
            (async () => {
                ...
                const helpRoles = await EmbedCreator.Create(`Command List - Page 2: Roles`, `< > - Parameter\n(< > < >...) - Optional parameter(s)\nExample for commands that require time:\n/tempban user:maxedcarp time:5 hours 3m 31 second`, false, gname, gicon, `Help Form`, `https://maxedcarp.net/imgs/overseer.png`, 0x00A012, [{
                    ...
                    name: '/togglepersistence',
                    value: "Enables role persistence, which allows roles to be reacquired if a member leaves and then rejoins."
                }, {
                    name: '/joinroles add <role>',
                    value: "Adds a roles to be assigned to new members."
                }, {
                    name: '/joinroles list',
                    value: "Lists all roles added on join."
                }, {
                    name: '/joinroles remove <index>',
                    value: "Prevent a role from being added on join (use /joinroles list to get the index)"
                }, {
                    name: '/secretkeys add <keyset> <role> <age requirement>',
                    value: "Assigns a role to a user if they send a message that matches the specified keyset and have the proper time-since-join (in seconds)"
                ...
                const helpMod = await EmbedCreator.Create(`Command List - Page 3: Moderation`, `< > - Parameter\n(< > < >...) - Optional parameter(s)\nExample for commands that require time:\n/tempban user:maxedcarp time:5 hours 3m 31 second`, false, gname, gicon, `Help Form`, `https://maxedcarp.net/imgs/overseer.png`, 0x00A012, [{
                    ...
                    value: "Bans a user (reason will be added to the user's notes)"
                }, {
                    name: '/tempban <user> <time> (<reason>)',
                    value: "Bans a user for a specified duration (The reason will be added to the user's notes)"
                }, {
                    name: '/timeout <user> <time> (<reason>)',
                    value: "Times a user out for the specified duration (The reason will be added to the user's notes)"
                }, {
                    name: '/userstats <user>',
                    value: "Check detailed information about the target user."
                }, {name: '/note add <user> <text>', value: "Assigns a note to a user."}, {
                    name: '/note list <user>',
                    value: "View a user's notes."
                }, {name: '/note delete <ID>', value: "Delete a user's note by ID."}, {
                    name: '/purge any (<count>)',
                    value: "Purges messages without any filters up to 100 messages."
                }, {
                    name: '/purge user <user> (<count>)',
                    value: "Purges messages sent by a specific user up to 100 messages."
                }, {
                ...
                const helpAdmin = await EmbedCreator.Create(`Command List - Page 4: Administration`, `< > - Parameter\n(< > < >...) - Optional parameter(s)\nExample for commands that require time:\n/tempban user:maxedcarp time:5 hours 3m 31 second`, false, gname, gicon, `Help Form`, `https://maxedcarp.net/imgs/overseer.png`, 0x00A012, [{
                    ...
                    name: '/setjoinmsg <text>',
                    value: "Sets the join message for the server. Type {@user} to ping the user, {servername} for server name, {username} for the user's username and {user} for the user's global name."
                }, {
                    name: '/setleavemsg <text>',
                    value: "Sets the leave message for the server. Type {@user} to ping the user, {servername} for server name, {username} for the user's username and {user} for the user's global name."
                }, {
